...
export const scratchFn = (target, complatePercent) => {
	...
	function getMouse(e, canvas) {
		...
		const offsetWrap = canvas.offsetParent || canvas;
	...
	//   console.log(`${filledInPixels  }%`);
		if (filledInPixels > complatePercent) {
